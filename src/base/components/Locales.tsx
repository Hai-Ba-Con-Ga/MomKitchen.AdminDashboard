...
const loadLocaleData = (locale: I18n) => {
  switch (locale) {
    case 'fr':
      return import('@/base/utils/locales/fr.json');
    case 'ro':
      return import('@/base/utils/locales/ro.json');
    case 'zh':
      return import('@/base/utils/locales/zh.json');
    case 'en':
    default:
      return import('@/base/utils/locales/en.json');
  }
};
