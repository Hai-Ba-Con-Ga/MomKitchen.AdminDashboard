...
const KitchenActionMenu = ({selectionRows, listData}: Props) => {
    ...
    const csvData = React.useMemo(()=>{
      if(listData){
        ...
        return [headerRow,...filterData.map(kitchen => [kitchen.id, kitchen?.no, kitchen?.name, kitchen?.address, kitchen?.location?.lng, kitchen?.location?.lat, kitchen?.ownerId, kitchen?.owner?.fullName,kitchen?.owner?.email, kitchen?.owner?.avatarUrl, kitchen?.area?.name,kitchen?.status ])]
      }
    ...
    const emails = React.useMemo(()=>{
        if(listData){
          ...
          return [...filterData.map(kitchen => kitchen?.owner?.email)]
        }
      },[selectionRows,listData])
            ...
            <DialogActions>
              ...
              <Button
                ...
                onClick={async () => {
                    ...
                    toast.success("Your email has been sent to kitchens' owners")
...
export default KitchenActionMenu