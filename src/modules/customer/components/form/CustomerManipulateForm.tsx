...
const CustomerManipulateForm = (props: Props) => {
    const {customer, isCreating = true, roles} = props
    ...
    <Grid item xs={12} md={8}>
      <Grid container spacing={3}>
            ...
            <Controller
              ...
              render={({
                ...
                <DatePicker
                  ...
                  />
                  {!!error && <FormHelperText error id="standard-weight-helper-text-email-login" >{error.message}
                </FormHelperText>}
                </>
        ...
        <Grid item xs={12}>
          ...
          <Stack
            ...
            <Controller
              ...
              render={({
                ...
                <FormControlLabel
              control={<Switch disabled={!isCreating}  sx={{ mt: 0 }} checked={value} onChange={(e,checked)=>{
          ...
          {!autoPasswordToggle &&  <Grid item  xs={12}>
          <Stack spacing={1.25}>
          ...
          <Stack spacing={1.25} mt={2}>
            <InputLabel htmlFor="customer-name">Confirmation Password</InputLabel>
            <TextField
              fullWidth
              id="customer-name"
